...
from Website.models import UlosCharacteristic # Sesuaikan dengan nama aplikasi Anda dan nama model yang benar
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for char_data in characteristics_to_seed:
            ulos_char, created = UlosCharacteristic.objects.update_or_create(
                NAME=char_data['NAME'],
                defaults=char_data
            )
            if created:
        ...
        self.stdout.write(self.style.SUCCESS('Ulos characteristic data seeding completed successfully!'))